...
<form method="post" action="options.php">
    ...
    <table class="form-table">
		...
		<input type="radio" name="bc_sort_location" value="1"<?php checked( '1', $bc_sort_location_value); ?>> <?php _e("Increasing Order only",'buffercode_captcha'); ?> <br><br>
		
		<input type="radio" name="bc_sort_location" value="2"<?php checked( '2', $bc_sort_location_value); ?>>  <?php _e("Decreasing Order only",'buffercode_captcha'); ?> <br><br>
		
		<input type="radio" name="bc_sort_location" value="3"<?php checked( '3', $bc_sort_location_value); ?>>  <?php _e("Random [Either Increasing or Decreasing]",'buffercode_captcha'); ?> 
		</td>
        </tr>
