...
<form method="post" action="options.php">
    ...
    <table class="form-table">
		...
		<input type="radio" name="bc_sort_location" value="5"<?php checked( '5', $bc_sort_location_value); ?>>  <?php _e("By Alphabets",'buffercode_captcha'); ?> <br><br>
		
			<input type="radio" name="bc_sort_location" value="6"<?php checked( '6', $bc_sort_location_value); ?>>  <?php _e("Addition or Subraction",'buffercode_captcha'); ?> <br><br>
		</td>
        </tr>
		
		<tr valign="top">
        <th scope="row"><?php _e("<b>Key</b>",'buffercode_captcha'); ?></th>
        <td>
		<input type="text" maxlength="15" name="bc_sort_key" value="<?php echo $bc_sort_key_value; ?>"> <?php _e("<b>[Please use random text and symbols for more security]</b>",'buffercode_captcha'); ?> <br><br>
