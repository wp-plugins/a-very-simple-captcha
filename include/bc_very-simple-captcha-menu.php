...
<form method="post" action="options.php">
    ...
    <table class="form-table">
		...
		<input type="radio" name="bc_sort_location" value="4"<?php checked( '4', $bc_sort_location_value); ?>>  <?php _e("Random [Increasing or Decreasing or Combo Box]",'buffercode_captcha'); ?> <br><br>
		</td>
        </tr>
