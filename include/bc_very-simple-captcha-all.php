...
///////////////////////////////////////////////////////////////
	...
	echo "</label>    "; 
	echo "<!-- buffercode.com Biggest Captcha input --><input id=\"bc_captcha_input_value\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"2\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
	<input type="hidden" value="<?php echo bc_encrypt($bc_captcha_input_passing); ?>" name="bc_big_small_captcha_rand_value" />
	<?php
	}
////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////
	...
	echo '<b>'.$bc_big_small_value_display.'</b>';
	echo "</label>    "; 
	echo "<!-- buffercode.com Smallest Captcha input --><input id=\"bc_captcha_input_value\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"2\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
	<input type="hidden" value="<?php echo bc_encrypt($bc_captcha_input_passing); ?>" name="bc_big_small_captcha_rand_value" />
	<?php
	}
...
//////////////////////////////////////////////////////////////
	...
	echo "</label>    "; 
	echo "<!-- buffercode.com Biggest or Smallest Captcha input --><input id=\"bc_captcha_input_value\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"5\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
	<input type="hidden" value="<?php echo bc_encrypt($bc_captcha_input_passing); ?>" name="bc_big_small_captcha_rand_value" />
	<?php
	}
////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////
	...
	echo "</label>    "; 
	echo "<!-- buffercode.com Biggest or Smallest Captcha input --><input id=\"bc_captcha_input_value\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"2\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
		<input type="hidden" value="<?php echo bc_encrypt($bc_captcha_input_passing); ?>" name="bc_big_small_captcha_rand_value" />
	<?php
	}
...
/////////////////////////////////////////////
	...
	echo '<b>'.$bc_add_sub_display.'</b>';
	echo "</label>    "; 
	echo "<!-- buffercode.com Biggest or Smallest Captcha input --><input id=\"bc_captcha_input_value\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"3\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
		<input type="hidden" value="<?php echo bc_encrypt($bc_captcha_input_passing); ?>" name="bc_big_small_captcha_rand_value" />
	<?php
	}
