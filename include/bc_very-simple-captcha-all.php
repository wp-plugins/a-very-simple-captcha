...
///////////////////////////////////////////////////////////////
	...
	echo '<input type=\'hidden\' value=\''.bc_encrypt($bc_captcha_input_passing).'\' name=\'bc_captcha_req_value\' />';
...
if ($_REQUEST['bc_captcha_req_text']==bc_decrypt($_REQUEST['bc_captcha_req_value'])) {
		return($comment);
}
else {
