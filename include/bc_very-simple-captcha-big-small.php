...
$bc_big_small_value_display=implode("__",$bc_big_small_number_rand);
...
if ($_REQUEST['bc_big_small_captcha_value'] =="" && isset($_REQUEST['bc_big_small_captcha_value'] ))
			wp_die( __('Please Enter Big or Small Value Captcha.', 'bc_big_small_simple_captcha' ) );
...
if ($_REQUEST['bc_big_small_captcha_value']==bc_decrypt($_REQUEST['bc_big_small_captcha_rand_value'])) {
		...
		//die(print_r($_REQUEST['bc_big_small_captcha_value']));
