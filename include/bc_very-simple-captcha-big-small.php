...
echo '<input type=\'hidden\' value=\''.esc_attr(base64_encode($bc_big_small_value_passing)).'\' name=\'bc_big_small_captcha_rand_value\' />';
...
if ($_REQUEST['bc_big_small_captcha_value']==esc_attr(base64_decode($_REQUEST['bc_big_small_captcha_rand_value']))) {
		return($comment);
}
else {
