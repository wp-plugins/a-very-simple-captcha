...
//Checking for Increasing or Decreasing order
	...
	echo "<label>"._e('<b>*</b> Please enter the <b>Biggest Number</b><br>','bc_big_small_simple_captcha')."</label><br>";
	}
	else {
	$bc_big_small_sort_var_min=min($bc_big_small_sort_var);
	$bc_big_small_value_passing=$bc_big_small_sort_var_min;
	echo "<label>"._e('<b>*</b> Please enter the <b>Smallest Number</b><br>','bc_big_small_simple_captcha')."</label><br>";
	}
...
echo "</label>    "; 
echo "<input id=\"bc_big_small_captcha_input\" type=\"text\" autocomplete=\"off\" name=\"bc_big_small_captcha_value\" value=\"\" maxlength=\"2\" size=\"15\" aria-required=\"true\" style=\"margin-bottom:0;display:inline;font-size: 12px;width: 90px;\" />"; ?>
