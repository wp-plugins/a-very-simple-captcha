...
echo '<input type=\'hidden\' value=\''.$bc_alphabets_value_passing_1.'\' name=\'bc_alphabets_captcha_rand_value_1\' />';
echo '<input type=\'hidden\' value=\''.$bc_alphabets_value_passing_2.'\' name=\'bc_alphabets_captcha_rand_value_2\' />';
